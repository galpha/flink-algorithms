 ...
 */
public class LPComputation implements
  GraphAlgorithm<Long, LPVertexValue, NullValue, Graph<Long, LPVertexValue,
    NullValue>> {
  /**
   ...
   */
  public LPComputation(int maxIterations) {
  ...
  public Graph<Long, LPVertexValue, NullValue> run(
    ...
    Graph<Long, LPVertexValue, NullValue> gellyGraph = graph.getUndirected();
    return gellyGraph
