...
public class BTGAlgorithm implements
  GraphAlgorithm<Long, BTGVertexValue, NullValue, Graph<Long, BTGVertexValue,
    NullValue>> {
  /**
  ...
  public Graph<Long, BTGVertexValue, NullValue> run(
    ...
    return undirectedGraph
      .runVertexCentricIteration(new BTGUpdater(), new BTGMessages(),
        maxIterations);
  }
  ...
  private static final class BTGUpdater extends
    ...
    public void updateVertex(Vertex<Long, BTGVertexValue> vertex,
      MessageIterator<BTGMessage> messages) throws Exception {
    ...
    private void processMasterVertex(Vertex<Long, BTGVertexValue> vertex,
      MessageIterator<BTGMessage> messages) {
    ...
    /**
     * Returns the current minimum value. This is always the last value
     * in the
     * list of BTG ids stored at this vertex. Initially the minimum value
     * is the
     * vertex id.
     *
     * @param vertex The current vertex
   ...
   */
  private static final class BTGMessages extends
